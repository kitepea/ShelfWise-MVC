...
using ShelfWise.DataAccess.DbInitializer;
using ShelfWise.DataAccess.Repository;
...
app.UseSession();
SeedDatabase(); // Invoke every time the application restarts
app.MapRazorPages(); // As the LoginPartial using asp-page, which belongs to Razor Pages
